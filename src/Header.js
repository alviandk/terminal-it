          ...
          >
            ...
            <ul className="navbar-nav">
              <li className="hs-has-mega-menu nav-item">
                ...
                <div 
                  className="hs-mega-menu dropdown-menu w-100 hs-mega-menu-desktop-lg animated megaMenu" 
                  aria-labelledby="demosMegaMenu" 
                >
                  <div className="navbar-dropdown-menu-promo">
                    <div className="navbar-dropdown-menu-promo-item">
                      <a className="navbar-dropdown-menu-promo-link active" href="">
                        <div className="d-flex">
                          ...
                          <div className="flex-grow-1 ms-3">
                            <span className="navbar-dropdown-menu-media-title">Main</span>
                    ...
                    <div className="navbar-dropdown-menu-promo-item">
                      <a className="navbar-dropdown-menu-promo-link " href="">
                        <div className="d-flex">
                          <div className="flex-shrink-0">
                            <span className="svg-icon svg-icon-sm text-primary">
                              <svg 
                          ...
                          <div className="flex-grow-1 ms-3">
                            <span className="navbar-dropdown-menu-media-title">Real Estate</span>
                            <p className="navbar-dropdown-menu-media-desc">
                        ...
                        <div className="d-flex">
                          ...
                          <div className="flex-grow-1 ms-3">
                            <span className="navbar-dropdown-menu-media-title">
                              Jobs 
                              <span className="badge bg-success rounded-pill ms-1">Hot</span>
                            </span>
                            <p className="navbar-dropdown-menu-media-desc">
                    ...
                    <div className="navbar-dropdown-menu-promo-item">
                      <a className="navbar-dropdown-menu-promo-link " href="">
                        <div className="d-flex">
                          ...
                          <div className="flex-grow-1 ms-3">
                            <span className="navbar-dropdown-menu-media-title">E-Commerce</span>
                            <p className="navbar-dropdown-menu-media-desc">
                    ...
                    <div className="navbar-dropdown-menu-promo-item">
                      <a className="navbar-dropdown-menu-promo-link " href="">
                        <div className="d-flex">
                          ...
                          <div className="flex-grow-1 ms-3">
                            <span className="navbar-dropdown-menu-media-title">App Marketplace</span>
                            <p className="navbar-dropdown-menu-media-desc">
                  ...
                  <div className="navbar-dropdown-menu-promo">
                    <div className="navbar-dropdown-menu-promo-item">
                      <a className="navbar-dropdown-menu-promo-link " href="">
                        <div className="d-flex">
                          ...
                          <div className="flex-grow-1 ms-3">
                            <span className="navbar-dropdown-menu-media-title">Help Desk</span>
                            <p className="navbar-dropdown-menu-media-desc">
                    ...
                    <div className="navbar-dropdown-menu-promo-item">
                      <a className="navbar-dropdown-menu-promo-link" href="" target="_blank">
                        <div className="d-flex">
                          <div className="flex-shrink-0">
                            <span className="svg-icon svg-icon-sm text-primary">
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.3" fillRule="evenodd" clipRule="evenodd" d="M12 17C16.4183 17 20 13.4183 20 9C20 4.58172 16.4183 1 12 1C7.58172 1 4 4.58172 4 9C4 13.4183 7.58172 17 12 17Z" fill="#035A4B"></path>
                                <path opacity="0.3" fillRule="evenodd" clipRule="evenodd" d="M6.53819 9L10.568 19.3624L11.976 18.8149L13.3745 19.3674L17.4703 9H6.53819ZM9.46188 11H14.5298L11.9759 17.4645L9.46188 11Z" fill="#035A4B"></path>
                                <path opacity="0.3" d="M10 22H14V22C14 23.1046 13.1046 24 12 24V24C10.8954 24 10 23.1046 10 22V22Z" fill="#035A4B"></path>
                                <path fillRule="evenodd" clipRule="evenodd" d="M8 17C8 16.4477 8.44772 16 9 16H15C15.5523 16 16 16.4477 16 17C16 17.5523 15.5523 18 15 18C15.5523 18 16 18.4477 16 19C16 19.5523 15.5523 20 15 20C15.5523 20 16 20.4477 16 21C16 21.5523 15.5523 22 15 22H9C8.44772 22 8 21.5523 8 21C8 20.4477 8.44772 20 9 20C8.44772 20 8 19.5523 8 19C8 18.4477 8.44772 18 9 18C8.44772 18 8 17.5523 8 17Z" fill="#035A4B"></path>
                              </svg>
                            </span>
                          </div>
  
                          <div className="flex-grow-1 ms-3">
                            <span className="navbar-dropdown-menu-media-title">New demo ideas?</span>
                            <p className="navbar-dropdown-menu-media-desc">
                              Send us your suggestions <i className="bi-box-arrow-up-right ms-1"></i>
                            </p>
                          </div>
                        </div>
                      </a>
              ...
              >
                ...
                <div 
                  className="hs-mega-menu hs-position-right dropdown-menu hs-mega-menu-desktop-lg animated megaMenuDocs" 
                  ...
                  <a className="navbar-dropdown-menu-media-link" href="">
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-3">
                        <span className="navbar-dropdown-menu-media-title">
                          Documentation 
                          <span className="badge bg-primary rounded-pill ms-1">v4.2</span>
                        </span>
                        <p className="navbar-dropdown-menu-media-desc">
                  ...
                  <a className="navbar-dropdown-menu-media-link" href="">
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-3">
                        ...
                        <p className="navbar-dropdown-menu-media-desc">Move quickly with copy-to-clipboard feature</p>
                      </div>
                    </div>
                  </a>
                </div>
              ...
              <ul className="navbar-nav">
                <li className="hs-has-mega-menu nav-item">
                  <a 
                    ...
                    href="#" 
                    role="button" 
                    aria-expanded="false">Landings
                  </a>
  
                  <div 
                    className="hs-mega-menu dropdown-menu w-100 hs-mega-menu-desktop-lg animated fadeOut megaMenuLandings" 
                    aria-labelledby="landingsMegaMenu" >
                    <div className="row">
                      <div className="col-lg-6 d-none d-lg-block">
                        <div 
                          className="navbar-dropdown-menu-banner bannerImage" >
                        ...
                        <div className="navbar-dropdown-menu-inner">
                          <div className="row">
                            <div className="col-sm mb-3 mb-sm-0">
                              <span className="dropdown-header">classNameic</span>
                              <a className="dropdown-item active" href="">Corporate</a>
                              <a className="dropdown-item" href="">Analytics <span className="badge bg-primary rounded-pill ms-1">Hot</span></a>
                              <a className="dropdown-item" href="">Studio</a>
                              <a className="dropdown-item" href="">Marketing</a>
                              <a className="dropdown-item" href="">Advertisement</a>
                              <a className="dropdown-item" href="">Consulting</a>
                            ...
                            <div className="col-sm">
                              <div className="mb-3">
                                ...
                                <a className="dropdown-item" href="">UI Kit</a>
                                <a className="dropdown-item" href="">SaaS</a>
                                <a className="dropdown-item" href="">Workflow</a>
                                <a className="dropdown-item" href="">Payment</a>
                                <a className="dropdown-item" href="">Tool</a>
                              </div>
  
                              <span className="dropdown-header">Onepage</span>
                              <a className="dropdown-item " href="">Corporate</a>
                              <a className="dropdown-item " href="">SaaS 
                                <span className="badge bg-primary rounded-pill ms-1">Hot</span>
                              </a>
                            </div>
                          </div>
                        </div>
                ...
                <li className="hs-has-sub-menu nav-item">
                  ...
                  <div 
                    className="hs-sub-menu dropdown-menu hs-sub-menu-desktop-lg animated megaMenuCompany" 
                    ...
                    <a className="dropdown-item" href="">Customer Story</a>
                    <a className="dropdown-item" href="">Careers</a>
                    <a className="dropdown-item" href="">Careers Overview</a>
                    <a className="dropdown-item" href="">Hire Us</a>
                    <a className="dropdown-item" href="">Pricing</a>
                    <a className="dropdown-item" href="">Contacts: Agency</a>
                    <a className="dropdown-item" href="">Contacts: Startup</a>
                  </div>
                </li>
                ...
                <li className="hs-has-sub-menu nav-item">
                  ...
                  <div 
                    className="hs-sub-menu dropdown-menu hs-sub-menu-desktop-lg animated fadeOut megaMenuCompany" 
                    ...
                    <div className="hs-has-sub-menu nav-item">
                      <a 
                        ...
                        href="#" 
                        role="button" 
                        aria-expanded="false">Authentication
                      </a>
                      <div 
                        className="hs-sub-menu dropdown-menu hs-sub-menu-desktop-lg animated megaMenuCompany" 
                        ...
                        <a 
                          ...
                          data-bs-target="#signupModal">Signup Modal
                        </a>
                        <div className="dropdown-divider"></div>
                        ...
                        <div className="dropdown-divider"></div>
                        <a className="dropdown-item" href="">Login Simple</a>
                        <a className="dropdown-item" href="">Signup Simple</a>
                        <a className="dropdown-item" href="">Reset Password Simple</a>
                      </div>
                    </div>
                    ...
                    <a className="dropdown-item " href="">Address</a>
                ...
                <li className="hs-has-sub-menu nav-item">
                  ...
                  <div 
                    ...
                    <a className="dropdown-item" href="">Coming Soon: Simple</a>
                    <a className="dropdown-item" href="">Maintenance Mode</a>
                    <a className="dropdown-item" href="">Status</a>
                    <a className="dropdown-item" href="">Invoice</a>
                    <a className="dropdown-item" href="">Error 404</a>
                  </div>
                </li>
                ...
                <li className="hs-has-sub-menu nav-item">
                  ...
                  <div 
                    ...
                    <a className="dropdown-item" href="">Metro</a>
                    <a className="dropdown-item" href="">Newsroom</a>
                    <div className="dropdown-divider"></div>
                    <a className="dropdown-item" href="">Article</a>
                    <a className="dropdown-item" href="">Author Profile</a>
                  </div>
                </li>
                ...
                <li className="hs-has-sub-menu nav-item">
                  ...
                  <div 
                    ...
                    <a className="dropdown-item" href="">Product Article</a>
                    <a className="dropdown-item" href="">Case Studies: Branding</a>
                    <a className="dropdown-item" href="">Case Studies: Product</a>
                  </div>
                </li>
